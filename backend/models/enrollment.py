"""
Enrollment model for DynamoDB operations
"""
...
class EnrollmentModel:
    """Model for enrollment operations in DynamoDB"""
    ...
    def create_enrollment(self, student_id, course_id, status="active"):
        ...
        Returns:
            Tuple (success, enrollment_data or error_message)
        """
        try:
    ...
    def get_enrollment(self, enrollment_id, student_id):
        ...
        Returns:
            Enrollment data dictionary or None
        """
        try:
    ...
    def get_enrollments_by_student(self, student_id):
        ...
        """
        try:
            # Use scan with filter since studentId is the sort key, not partition key
            response = self.table.scan(
    ...
    def update_enrollment_status(self, enrollment_id, student_id, status):
        ...
        Returns:
            Tuple (success, updated_enrollment_data or error_message)
        """
        try:
