...
def list_courses():
    ...
    try:
        ...
        # For admins, show all courses (unless filtered by instructorId)
            ...
            courses = course_model.list_courses(instructor_id=instructor_id, category=category)
...
def create_course():
    ...
    try:
        ...
        success, result = course_model.create_course(
            instructor_id=instructor_id, title=title, description=description, category=category
        )
...
def update_course(course_id):
    ...
    try:
        ...
        success, result = course_model.update_course(course_id=course_id, instructor_id=instructor_id, **update_data)
...
def delete_course(course_id):
    ...
    try:
        ...
        success, error_msg = course_model.delete_course(course_id=course_id, instructor_id=instructor_id)
